...
<div id="comments" class="comments-area">
	...
	<div class="comments-area-wrapper">
		...
		<nav id="comment-nav-above" class="navigation comment-navigation comment-navigation-above" role="navigation">
			<h1 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'allium' ); ?></h1>
			<div class="nav-links">
				<div class="nav-previous"><?php previous_comments_link( esc_html__( 'Older Comments', 'allium' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments', 'allium' ) ); ?></div>
			</div><!-- .nav-links -->
	...
	<div class="no-comments-wrapper">
		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'allium' ); ?></p>
	</div><!-- .comments-area-wrapper -->
	<?php endif; ?>
